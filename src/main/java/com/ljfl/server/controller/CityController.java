...
public class CityController {
    ...
    @ApiOperation(value = "【城市】城市列表查询", httpMethod = "GET", notes = "城市列表查询")
    ...
    @ApiOperation(value = "【城市】垃圾类别列表查询", httpMethod = "GET", notes = "垃圾类别列表查询")
    @RequestMapping(value = "/listCate", method = RequestMethod.GET)
    public Object listCate(GarbageOneReq req) {
    ...
    @ApiOperation(value = "【城市】垃圾列表查询", httpMethod = "GET", notes = "垃圾列表查询")
    @RequestMapping(value = "/listGarbage", method = RequestMethod.GET)
    public Object listGarbage(GarbageTwoReq req) {
    ...
    @ApiOperation(value = "【城市】官方文件查询", httpMethod = "GET", notes = "官方文件查询")
    @RequestMapping(value = "/listGovFile", method = RequestMethod.GET)
    public Object listGovFile(GovFileReq req) {
